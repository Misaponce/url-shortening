  ...
  return (
    <div className='navbar bg-base-100'>
      ...
      <div className='navbar-end hidden lg:flex'>
        <button className='btn rounded-full log-in-btn'>Login</button>
      ...
      <div className='navbar-end lg:hidden'>
        <details  className="dropdown dropdown-end">
          ...
          <ul tabIndex={0} className="menu menu-lg dropdown-content mt-1 z-[1] -translate-x-10 shadow rounded-box w-96 text-white p-8">
            ...
            <li><button className='btn btn-ghost rounded-full hover:text-white'>Login</button></li>
